...
<div class="stepper stepper-pills stepper-column d-flex flex-column flex-lg-row" id="stepper_cadastro_exame">
    ...
    <div class="flex-row-fluid">
        <!--begin::Form-->
        <form class="form w-lg-100 mx-auto" id="formCadastrarExame" name="formCadastrarExame" novalidate="novalidate">
            <!--begin::Group-->
            <div class="mb-5">
                <!--begin::Step 1-->
                <div class="flex-column current" data-kt-stepper-element="content">
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input id="novoPaciente" name="pacienteNovo" class="form-check-input" type="checkbox" value="1"/>
                    ...
                    <div id="form_seleciona_paciente">
                        <div class="fv-row mb-10">
                            ...
                            <div class="border rounded" >
                                <select id="kt_docs_select2_rich_content" class="form-select form-select-solid" name="paciente" data-placeholder="Selecione o paciente">
                                    <option></option>
                            ...
                            <div style="display: none;" id="feedbackSelectPaciente" class="fv-plugins-message-container invalid-feedback">
                                <div data-field="text_input" data-validator="notEmpty">Selecione um Paciente ou Cadastre um Novo</div>
                            </div>
                        </div>
                    </div>
                    <div id="form_novo_paciente" style="display: none;">
                        <div class="row mb-5">
                            <div class="col-8">
                                <label class="fs-6 fw-semibold  form-label"><span class="required">Nome do Paciente</span></label>
                                <input type="text" class="form-control form-control-solid" name="nome" value="" />
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control form-control-solid mask_cpf" name="cpf" value="" />
                                <div id="campoNomeFb" class="invalid-feedback">CPF é obrigatório!</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <label class="fs-6 fw-semibold form-label"><span class="required">Data de Nascimento</span></label>
                                <input type="text" class="form-control form-control-solid mask_date" name="dtnascimento" value="" />
                                <div id="campoNomeFb" class="invalid-feedback">Data de Nascimento é obrigatória!</div>
                            </div>
                            <div class="col-6">
                                <label class="fs-6 fw-semibold form-label"><span>Sexo</span></label>
                                <select name="sexo" class="form-select form-select-solid" aria-label="Select example">
                                ...
                                <div data-repeater-item>
                                    <div class="form-group row mb-4">
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" name="exame" class="form-control form-control-solid mb-2 mb-md-0" placeholder="Nome do Procedimento" />
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Data:</label>
                                            <input type="text" name="data" data-kt-repeater="mask_datetime" class="form-control form-control-solid mb-2 mb-md-0 mask_datetime" value="{{ \Carbon\Carbon::now()->format('d/m/Y H:i') }}" placeholder="Data do Exame" />
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label">Modalidade:</label>
                                            <select name="modalidade" class="form-select form-select-solid" aria-label="Select example">
                                                <option value="">-- Selecione uma opção --</option>
                                        ...
                                        <div class="col-md-1">
                                            <a href="javascript:;" data-repeater-delete class="btn btn-icon btn-sm btn-light-danger mt-3 mt-md-8">
                ...
                <div class="flex-column" data-kt-stepper-element="content">
                    <div class="d-flex align-items-sm-center mb-5 fb-row">
                        ...
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            ...
                            <span id="labelNovoPaciente" class="badge badge-lg badge-light-primary fw-bold my-2"></span>
                        </div>
                    </div>
...
var optionFormat = (item) => {
    ...
    template += '<span class="text-muted fs-6">' + item.element.getAttribute('data-kt-rich-content-subcontent') + '</span>';
    template += '</div>';
    template += '</div>';
        ...
        if(o.pacienteNovo)
        {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#nascimentoPaciente').html(moment(response.data.dtnascimento, "YYYY-MM-DD").format('DD/MM/YYYY'));
...
$('#novoPaciente').on('change', function() {
    if($(this).is(':checked'))
    {
        ...
        console.log('seleciona paciente');
...
$('[data-kt-stepper-action="submit"]').click(function() {
    ...
    if(o.pacienteNovo)
    {
        var exameDataCreate = { "pacienteNome": o.nome, "pacienteCPF": o.cpf, "pacienteDtNascimento": o.dtnascimento, "pacienteSexo": o.sexo, "exames": examesData.exames_repeater  };
    }else{
        var exameDataCreate = { "pacienteId": o.paciente, "exames": examesData.exames_repeater  };
    }
    $.ajaxSetup({
        headers: {
