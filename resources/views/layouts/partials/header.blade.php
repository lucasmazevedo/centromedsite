        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-lg-0 align-items-stretch fw-semibold px-lg-0 my-5 px-2"
                    ...
                    <div class="menu-item">
                        <a href="{{ route('exames.index') }}"
                            class="menu-link {{ request()->is('/') ? 'active' : '' }} {{ request()->is('exames') ? 'active' : '' }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a href="{{ route('laudos.index') }}"
                            class="menu-link {{ request()->is('laudos') ? 'active' : '' }}">
                            <span class="menu-icon">
                                <i class="bi bi-journal-medical fs-3"></i>
                            </span>
                            <span class="menu-title">Laudos</span>
                        </a>
                    </div>
                    <!--end:Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item">
                        <a href="{{ route('pacientes.index') }}"
                            class="menu-link {{ request()->is('pacientes') ? 'active' : '' }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a href="{{ route('configuracoes.index') }}"
                            class="menu-link {{ request()->is('configuracoes') ? 'active' : '' }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a href="{{ route('relatorios.index') }}"
                            class="menu-link {{ request()->is('relatorios') ? 'active' : '' }}">
                            <span class="menu-icon">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <!--begin::Menu toggle-->
                    <!--begin::Menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold fs-base w-175px py-4"
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4 cursor-pointer"
                        data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                        data-kt-menu-placement="bottom-end">
                        <span class="text-dark fs-8 fw-semibold lh-1 mb-1">{{ Auth::user()->name }}</span>
                        <span class="text-primary fs-7 fw-semibold lh-1"></span>
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px py-4"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="fw-semibold text-muted text-hover-primary fs-7">
                                    </p>
                                </div>
                                <!--end::Username-->
                            </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('usuarios.perfil') }}" class="menu-link px-5">Meus Dados</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
